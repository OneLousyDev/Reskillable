package com.lousiesmods.skillsreborn.base.asm;
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (itrNode.getOpcode() == Opcodes.BIPUSH) {
                            ...
                            if (intNode.operand == 124) {
                                MethodInsnNode newNode = new MethodInsnNode(Opcodes.INVOKESTATIC, "src/broken/skillsreborn/client/gui/handler/InventoryTabHandler", "getPotionOffset", "()I", false);
